...
('9780307474728', 1, 'PRESTADO'), ('9780307474728', 2, 'RESERVADO'), ('9780307474728', 3, 'DISPONIBLE'), ('9780307474728', 4, 'DISPONIBLE'), ('9780307474728', 5, 'DISPONIBLE'),
-- La casa de los espíritus (4)
('9780060934347', 1, 'PRESTADO'), ('9780060934347', 2, 'PRESTADO'), ('9780060934347', 3, 'DISPONIBLE'), ('9780060934347', 4, 'DISPONIBLE'),
-- Ficciones (3)
('9788420633114', 1, 'RESERVADO'), ('9788420633114', 2, 'DISPONIBLE'), ('9788420633114', 3, 'DISPONIBLE'),
-- Rayuela (3)
('9788439734475', 1, 'PRESTADO'), ('9788439734475', 2, 'RESERVADO'), ('9788439734475', 3, 'DISPONIBLE'),
-- El resplandor (6)
('9781501143519', 1, 'PRESTADO'), ('9781501143519', 2, 'PRESTADO'), ('9781501143519', 3, 'DISPONIBLE'), ('9781501143519', 4, 'DISPONIBLE'), ('9781501143519', 5, 'DISPONIBLE'), ('9781501143519', 6, 'DISPONIBLE'),
-- Harry Potter 1 (10)
('9780747532699', 1, 'PRESTADO'), ('9780747532699', 2, 'PRESTADO'), ('9780747532699', 3, 'DISPONIBLE'), ('9780747532699', 4, 'DISPONIBLE'), ('9780747532699', 5, 'DISPONIBLE'), ('9780747532699', 6, 'DISPONIBLE'), ('9780747532699', 7, 'DISPONIBLE'), ('9780747532699', 8, 'DISPONIBLE'), ('9780747532699', 9, 'DISPONIBLE'), ('9780747532699', 10, 'DISPONIBLE'),
-- Juego de Tronos (5)
('9780553103540', 1, 'PRESTADO'), ('9780553103540', 2, 'PRESTADO'), ('9780553103540', 3, 'RESERVADO'), ('9780553103540', 4, 'DISPONIBLE'), ('9780553103540', 5, 'DISPONIBLE'),
-- Fundación (4)
('9780553293357', 1, 'PRESTADO'), ('9780553293357', 2, 'DISPONIBLE'), ('9780553293357', 3, 'DISPONIBLE'), ('9780553293357', 4, 'DISPONIBLE'),
-- Asesinato en el Orient Express (4)
('9780007119318', 1, 'PRESTADO'), ('9780007119318', 2, 'DISPONIBLE'), ('9780007119318', 3, 'DISPONIBLE'), ('9780007119318', 4, 'DISPONIBLE'),
-- El capitán Alatriste (3)
('9788420412146', 1, 'PRESTADO'), ('9788420412146', 2, 'DISPONIBLE'), ('9788420412146', 3, 'DISPONIBLE'),
-- El amor en los tiempos del cólera (3)
('9780307389732', 1, 'PRESTADO'), ('9780307389732', 2, 'PRESTADO'), ('9780307389732', 3, 'DISPONIBLE'),
-- It (5)
('9781501144264', 1, 'PRESTADO'), ('9781501144264', 2, 'PRESTADO'), ('9781501144264', 3, 'DISPONIBLE'), ('9781501144264', 4, 'DISPONIBLE'), ('9781501144264', 5, 'DISPONIBLE'),
-- Harry Potter 2 (8)
('9780747538486', 1, 'PRESTADO'), ('9780747538486', 2, 'DISPONIBLE'), ('9780747538486', 3, 'DISPONIBLE'), ('9780747538486', 4, 'DISPONIBLE'), ('9780747538486', 5, 'DISPONIBLE'), ('9780747538486', 6, 'DISPONIBLE'), ('9780747538486', 7, 'DISPONIBLE'), ('9780747538486', 8, 'DISPONIBLE'),
-- Choque de Reyes (4)
('9780553108033', 1, 'PRESTADO'), ('9780553108033', 2, 'RESERVADO'), ('9780553108033', 3, 'RESERVADO'), ('9780553108033', 4, 'DISPONIBLE'),
-- Fundación e Imperio (3)
('9780553294385', 1, 'PRESTADO'), ('9780553294385', 2, 'DISPONIBLE'), ('9780553294385', 3, 'DISPONIBLE'),
-- El asesinato de Roger Ackroyd (4)
('9780007122035', 1, 'PRESTADO'), ('9780007122035', 2, 'RESERVADO'), ('9780007122035', 3, 'DISPONIBLE'), ('9780007122035', 4, 'DISPONIBLE'),
-- Sabotaje (2)
('9788499928500', 1, 'PRESTADO'), ('9788499928500', 2, 'DISPONIBLE'),
-- La reina del sur (3)
('9788466338141', 1, 'RESERVADO'), ('9788466338141', 2, 'RESERVADO'), ('9788466338141', 3, 'DISPONIBLE'),
-- El Aleph (Borges, reedición) (4)
('9788408045076', 1, 'PRESTADO'), ('9788408045076', 2, 'DISPONIBLE'), ('9788408045076', 3, 'DISPONIBLE'), ('9788408045076', 4, 'DISPONIBLE'),
-- Bestiario (Cortázar) (3)
('9788420442389', 1, 'PRESTADO'), ('9788420442389', 2, 'PRESTADO'), ('9788420442389', 3, 'DISPONIBLE');
